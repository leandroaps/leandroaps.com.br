      ...
      <footer className="bg-[#222222] text-white py-16 px-6">
        <div className="max-w-7xl mx-auto">
          <div className="grid md:grid-cols-3 gap-12 mb-12">
            ...
            {/* Navigation */}
            <div>
              <h4 className="text-xs font-semibold tracking-[0.15em] uppercase text-[#7B7B7B] mb-4">
                Navigation
              </h4>
              <ul className="space-y-2">
                {NAV_ITEMS.map(({ label, href }) => (
                  <li key={href}>
                    <a
                      href={href}
                      className="text-sm text-[#7B7B7B] hover:text-white transition-colors"
                    >
                      {label}
                    </a>
                  </li>
              ...
              <ul className="space-y-3">
                ...
                <li>
                  <a
                    ...
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-2 text-sm text-[#7B7B7B] hover:text-white transition-colors"
                  >
                    <GitHubIcon /> GitHub
                  </a>
                </li>
